...
export const fetchCarros = createAsyncThunk(
  ...
  async (params = {}, { rejectWithValue }) => {
    try {
      ...
      console.log('📦 fetchCarros response:', response.data)
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchCarros.fulfilled, (state, action) => {
        state.loading = false
        state.carros = action.payload.data
      ...
      .addCase(fetchCarroById.fulfilled, (state, action) => {
        state.loading = false
        state.selectedCarro = action.payload
      })
      ...
      .addCase(createCarro.fulfilled, (state, action) => {
        ...
        state.carros.unshift(action.payload)
      })
      ...
      .addCase(updateCarro.fulfilled, (state, action) => {
        ...
        const index = state.carros.findIndex(c => c.id === action.payload.id)
        if (index !== -1) {
          state.carros[index] = action.payload
        }
        if (state.selectedCarro?.id === action.payload.id) {
          state.selectedCarro = action.payload
        }
      })
      ...
      .addCase(fetchCajoneras.fulfilled, (state, action) => {
        ...
        state.cajoneras = action.payload
      })
      ...
      .addCase(createCajonera.fulfilled, (state, action) => {
        state.cajoneras.push(action.payload)
      })

      // Update cajonera
      .addCase(updateCajonera.fulfilled, (state, action) => {
        const index = state.cajoneras.findIndex(c => c.id === action.payload.id)
        if (index !== -1) {
          state.cajoneras[index] = action.payload
        }
      })
      ...
      .addCase(fetchMantenciones.fulfilled, (state, action) => {
        ...
        state.mantenciones = action.payload
      })
      ...
      .addCase(registrarMantencion.fulfilled, (state, action) => {
        state.mantenciones.unshift(action.payload)
      })
      ...
      .addCase(fetchMaterialCarro.fulfilled, (state, action) => {
        ...
        state.materialAsignado = action.payload
      })
      ...
      .addCase(asignarMaterialCarro.fulfilled, (state, action) => {
        state.materialAsignado.push(action.payload)
      })

      // Cambiar cajonera
      .addCase(cambiarCajonera.fulfilled, (state, action) => {
        const index = state.materialAsignado.findIndex(m => m.id === action.payload.id)
        if (index !== -1) {
          state.materialAsignado[index] = action.payload
        }
      })
